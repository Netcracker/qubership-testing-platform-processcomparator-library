...
public class TestsConfig {
    ...
    private final static Logger log = Config.getLogger(TestsConfig.class);
    ...
    private TestsConfig() throws SVNClientException {
        ...
        log.info("Using "+clientType+" factory ...");
...
//        }
        log.info("Using "+adminClientType+" factory for admin commands...");

...
/**
 * Utility class for common SVN-related helper methods such as date and revision parsing.
 *
 * @author Philip Schatz (schatz at tigris)
 * @author Daniel Rall
 * @summary Provides static utility methods for working with SVN URLs, revisions, and dates.
 */
class Helper {

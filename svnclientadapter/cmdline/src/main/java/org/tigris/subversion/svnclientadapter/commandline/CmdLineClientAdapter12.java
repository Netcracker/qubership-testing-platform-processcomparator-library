...
public class CmdLineClientAdapter12 extends CmdLineClientAdapter {
     ...
     * </p>
     * @param notificationHandler the handler responsible for processing SVN operation notifications and logs
     */
    ...
    /* (non-Javadoc)
     * @see org.tigris.subversion.svnclientadapter.commandline.CmdLineClientAdapter#getStatus(
    ...
    protected CmdLineStatusPart[] getCmdStatuses(String[] paths,
        ...
        String statusLinesString = ((SvnCommandLine12) cmd).statusByStdout(paths, descend, getAll,
                false, ignoreExternals);
    ...
    protected ISVNAnnotations annotate(String target,
        ...
        try {
            ...
            String annotations = ((SvnCommandLine12) cmd).annotateByStdout(target, toString(revisionStart),

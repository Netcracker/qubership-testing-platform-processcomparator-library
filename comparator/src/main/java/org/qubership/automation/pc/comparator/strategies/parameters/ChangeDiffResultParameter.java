...
public class ChangeDiffResultParameter implements ParameterData {

    private JsonComparatorParameters jsonComparatorParameters;

    public ChangeDiffResultParameter(JsonComparatorParameters jsonComparatorParameters) {
        this.jsonComparatorParameters = jsonComparatorParameters;
    }

    @Override
    public List<ChangeDiffResultRule> getParameterData(Parameters parameters) {
        return Optional.ofNullable(parameters.getParameters(jsonComparatorParameters.getParameterName()))
                ...
                .stream()
                .map(ChangeDiffResultRule::buildObject)

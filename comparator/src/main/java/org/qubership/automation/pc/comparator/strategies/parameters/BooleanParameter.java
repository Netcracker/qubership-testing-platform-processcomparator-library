...
public class BooleanParameter implements ParameterData {

    private JsonComparatorParameters jsonComparatorParameters;

    public BooleanParameter(JsonComparatorParameters jsonComparatorParameters) {
        this.jsonComparatorParameters = jsonComparatorParameters;
    }

    @Override
    public Boolean getParameterData(Parameters parameters) {
        return Optional
                .ofNullable(parameters.getParameter(jsonComparatorParameters.getParameterName()))
                .map(Boolean::valueOf)

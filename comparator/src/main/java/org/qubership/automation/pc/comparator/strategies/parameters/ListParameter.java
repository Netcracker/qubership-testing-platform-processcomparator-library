...
public class ListParameter implements ParameterData {

    private ComparatorParameters comparatorParameters;

    public ListParameter(ComparatorParameters comparatorParameters) {
        this.comparatorParameters = comparatorParameters;
    }

    @Override
    public List<String> getParameterData(Parameters parameters) {
        return Optional
                .ofNullable(parameters.getParameters(comparatorParameters.getParameterName()))
